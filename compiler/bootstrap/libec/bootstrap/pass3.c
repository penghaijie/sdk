...
{
if((_class->type != 1000 || !strcmp(_class->fullName, "enum") || !strcmp(_class->fullName, "ecere::com::Instance") || (_class->dataTypeString && !strcmp(_class->dataTypeString, "char *")) || !strcmp(_class->fullName, "uint64") || !strcmp(_class->fullName, "uint32") || !strcmp(_class->fullName, "uint16") || !strcmp(_class->fullName, "uint") || !strcmp(_class->fullName, "byte")))
{
(__ecereNameSpace__ecere__com__eSystem_Delete(spec->name), spec->name = 0);
if(_class->dataTypeString)
{
if(!strcmp(_class->dataTypeString, "uint64") || !strcmp(_class->dataTypeString, "uint32") || !strcmp(_class->dataTypeString, "uint16") || !strcmp(_class->dataTypeString, "uint") || !strcmp(_class->dataTypeString, "byte"))
{
if(!_class->dataType)
...
{
spec->type = 5;
spec->name = __ecereNameSpace__ecere__sys__CopyString("struct __ecereNameSpace__ecere__com__Class * class, void *");
}
break;
case 1:
break;
...
{
if(targetPlatform == 1)
spec->name = __ecereNameSpace__ecere__sys__CopyString("__declspec(dllexport)");
else
spec->name = __ecereNameSpace__ecere__sys__CopyString("__attribute__ ((visibility(\"default\")))");
}
else
{
if(targetPlatform == 1)
spec->name = __ecereNameSpace__ecere__sys__CopyString("extern __declspec(dllexport)");
else
spec->name = __ecereNameSpace__ecere__sys__CopyString("extern __attribute__ ((visibility(\"default\")))");
}
}
break;
}
...
if(targetPlatform == 1)
decl->extended.extended = __ecereNameSpace__ecere__sys__CopyString("extern __declspec(dllexport)");
else
decl->extended.extended = __ecereNameSpace__ecere__sys__CopyString("extern __attribute__ ((visibility(\"default\")))");
}
else if(!strcmp(decl->extended.extended, "stdcall") || !strcmp(decl->extended.extended, "_stdcall") || !strcmp(decl->extended.extended, "__stdcall") || !strcmp(decl->extended.extended, "__stdcall__"))
{
(__ecereNameSpace__ecere__com__eSystem_Delete(decl->extended.extended), decl->extended.extended = 0);
if(targetPlatform == 1)
decl->extended.extended = __ecereNameSpace__ecere__sys__CopyString("__attribute__((__stdcall__))");
else
decl->extended.extended = __ecereNameSpace__ecere__sys__CopyString("");
}
}
if(decl->declarator)
InstDeclPassDeclarator(decl->declarator);
